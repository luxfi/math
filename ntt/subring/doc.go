...
// Package subring owns the Lattigo-derived Montgomery NTT body —
// SubRing layout, root-table generator, scalar primitives
...
//
//   - github.com/luxfi/math/ntt           — the Service / Backend
//     interface (recommended for new code).
